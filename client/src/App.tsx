...
function App() {
  ...
  // Hard fallback: show game after 10s no matter what.
  // Does NOT set hasLoadedOnce so doLoad can still finish and restore the save
  // in the background without overwriting the game state with defaults.
  useEffect(() => {
