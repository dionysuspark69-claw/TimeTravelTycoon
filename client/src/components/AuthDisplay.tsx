...
export function AuthDisplay() {
  const { user, isAuthenticated, loading, loginWithUsername, loginWithGoogle, logout } = useAuth();
      ...
      <Card className="bg-black/80 backdrop-blur-sm border-cyan-500/30 p-3 min-h-[44px]">
        <div className="flex flex-col gap-2">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="w-full bg-white/5 hover:bg-white/10 text-white border border-white/20 h-8 flex items-center gap-2"
          >
